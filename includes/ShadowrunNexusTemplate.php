	...
	public function execute() {
		...
		<div id="sr-nexus-wrapper" class="sr-nexus-wrapper">
			...
			<footer id="sr-nexus-footer" class="sr-nexus-footer">
                ...
                <div class="sr-nexus-kofi" style="text-align: center; margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid #333333; width: 100%; display: block;">
					<div style="max-width: 150px; margin: 0 auto; display: block;">
					<a href="https://ko-fi.com/yourusername" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; background-color: #13C3FF; color: #fff; padding: 0.3rem 0.8rem; border-radius: 4px; font-weight: bold; font-size: 0.9rem; text-decoration: none; width: auto;">
						<svg style="margin-right: 0.4rem; width: 16px; height: 16px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white">
